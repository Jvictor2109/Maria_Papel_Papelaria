													...
													<table class="alt">
														...
														<tbody>
															<?php 
																...
																$sql = "SELECT * FROM encomenda_editora
                                                                        JOIN utilizador ON encomenda_editora.id_utilizador = utilizador.id_utilizador";
																...
																foreach($linhas as $linha){?>
																	<tr>
																		<td><?= $linha['id_encomenda_editora'] ?></td>
																		<td><?= $linha['username'] ?></td>
																		<td><?= $linha["data_encomenda_editora"] ?></td>
                                                                        <td><a href="<?= $linha["doc_encomenda_editora"] ?>" download>Download</a></td>
																	</tr>
																<?php }
